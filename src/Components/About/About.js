              ...
              <div className="col s12 l12">
                  <div className="card">                      
                    <div className="card-content">
                      <h4 id="aboutText" className="center">I am a full-stack developer living in Chicago. I also am a Realtor at <a href="https://kalerealty.com/">Kale Realty</a>.
                    ...
                    <div className="card-action">
                      <h5 className="center">Want to collab on something? Shoot me an <a className="light-blue-text">email</a></h5>
                    </div>
                  </div>
              </div>
          </div>          
